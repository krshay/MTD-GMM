...
\newcommand{\A}[0]{{\buildrel _{\circ} \over {\mathrm{A}}}}
...
% Single address.
% ---------------
\name{Authors\thanks{S.K. is supported by the Yitzhak and Chaya Weinstein Research Institute for Signal Processing. T.B. is supported in part by NSF-BSF grant no. 2019752, and the Zimin Institute for Engineering Solutions Advancing Better Lives.}}
...
\asaf{TODO: rephrase --- However for our choice of the moment function~\eqref{Eq-2-3}, it is enough to apply the covariance on the empirical part,
	\begin{equation}\label{Eq-2-7}
		\Cov[g_N(\theta)] = \Cov\left[\left[y_i; \ldots; y_i^{\otimes {k_M}}\right]\right].
	\end{equation}
